...
public class ModItems {
    ...
    public static final RegistryObject<Item> WINGS_TACK_PATTERN = ITEMS.register("wings_tack_pattern",() -> new TackPatternItem("wings",(new Item.Properties()).stacksTo(1).tab(ModCreativeTab.instance)));
