...
public enum TackPattern implements StringRepresentable {
    ...
    HEAD_HAT_BORDER("head_hat_border","none,head",false,null),
    HEAD_HAT_LONG("head_hat_long","none,head",false,null),
    HEAD_HAT_LONG_BORDER("head_hat_long_border","none,head",false,null),
