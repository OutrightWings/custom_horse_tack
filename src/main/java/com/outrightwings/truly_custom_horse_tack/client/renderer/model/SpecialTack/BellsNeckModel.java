...
public class BellsNeckModel extends SpecialTackModel {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition CE = bells.addOrReplaceChild("CE", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.5F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition CC = bells.addOrReplaceChild("CC", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.5F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition CW = bells.addOrReplaceChild("CW", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.5F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition FW = bells.addOrReplaceChild("FW", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(0.0F, 1.5F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(6.5F, -3.0F, -16.0F));

        PartDefinition BW = bells.addOrReplaceChild("BW", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(0.0F, 1.5F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(6.5F, -6.0F, -13.0F));

        PartDefinition FE = bells.addOrReplaceChild("FE", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(0.0F, 1.5F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.5F, -3.0F, -16.0F));

        PartDefinition BE = bells.addOrReplaceChild("BE", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
